...
function recognize_url_hash(){
    if(window.location.hash=="#index" || window.location.hash==""){
        ...
        $.post("/news/news_title", function(ret){
            ...
            $("#title_1").html(temp.title[0])
            $("#title_2").html(temp.title[1])
            $("#title_3").html(temp.title[2])
            $("#title_4").html(temp.title[3])
            $("#thumbs_title_1").html(temp.title[0])
            $("#thumbs_title_2").html(temp.title[1])
            $("#thumbs_title_3").html(temp.title[2])
            $("#thumbs_title_4").html(temp.title[3])
        })
    }else{
